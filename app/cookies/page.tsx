...
export const metadata: Metadata = { title:"Cookie Policy — namekind", description:"How namekind uses browser storage, cookies, and similar technologies." };
...
export default function CookiesPage() { return <InfoLayout eyebrow="Browser choices" title="Cookie Policy" intro="A plain-language guide to the browser storage and similar technologies namekind uses or plans to use.">
  ...
  <section><h2>Your choices</h2><p>You can control or delete cookies and local storage through your browser. Blocking essential storage may affect shortlist continuity. Before advertising is activated, namekind will add an appropriate consent-management process for regions where consent is required. Google advertising preferences can be managed through <a href="https://adssettings.google.com" target="_blank" rel="noreferrer">Google Ads Settings</a>.</p></section>
