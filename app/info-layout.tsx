...
export function InfoLayout({ eyebrow, title, intro, children }: { eyebrow:string; title:string; intro:string; children:React.ReactNode }) {
  return <main className="info-page">
    <header className="site-header">
      ...
      <nav aria-label="Information navigation"><Link href="/baby-names">Baby names</Link><Link href="/pet-names">Pet names</Link><Link href="/guides/choosing-a-baby-name">Guide</Link><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link className="save" href="/">Find your names</Link></nav>
    </header>
